...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public void create(Employee emp) throws DAOException {
		...
		String query = "INSERT INTO EMPLOYEES (login, password, first_name, last_name, salary, department_id, EMPLOYEE_ID)  VALUES ( ?,?,?,?,?,?,? )";

		Object[] params = new Object[] { emp.getUsername(), emp.getPassword(), emp.getLastname(), emp.getFirstname(), emp.getSalary(), emp.getDepartmentId(), emp.getEmployeeId() };
